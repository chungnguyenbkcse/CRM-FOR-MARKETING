...
$filename = '/home/www/html/mkt.tranthu.vn/custom/modules/Leads/chia_data/16-10-2023/chuyen_code.csv';
...
for ($i = 0; $i < $dataCount; $i++) {
    ...
    $lead_id = $lead_ids[$i];
    $query = "UPDATE leads SET ro_name = '{$user}', owned_branch = 'HCM_2',  sale_stage = '1', lead_status = '1' WHERE id = '{$lead_id}'";
