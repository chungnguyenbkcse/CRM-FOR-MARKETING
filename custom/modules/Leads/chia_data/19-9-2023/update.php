...
$filename = '/home/www/html/mkt.tranthu.vn/custom/modules/Leads/chia_data/19-9-2023/data_19_9.csv';
...
for ($i = 0; $i < $dataCount; $i++) {
    ...
    $lead_id = $lead_ids[$i];
    $query = "UPDATE leads SET ro_name = '', owned_branch = '' WHERE id = '{$lead_id}'";
