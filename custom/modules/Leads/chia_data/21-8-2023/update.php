...
$filename = '/home/www/html/mkt.tranthu.vn/custom/modules/Leads/chia_data/21-8-2023/data_21_8.csv';
...
for ($i = 0; $i < $dataCount; $i++) {
    ...
    $lead_id = $lead_ids[$i];
    $query = "UPDATE leads SET ro_name = '{$user}', owned_branch = 'HCM 1',  sale_stage = '1', lead_status = '1' WHERE id = '{$lead_id}'";
