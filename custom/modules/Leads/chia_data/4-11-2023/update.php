...
$filename = '/home/www/html/mkt.tranthu.vn/custom/modules/Leads/chia_data/4-11-2023/data_4_11 - Trang tính1.csv';
...
for ($i = 0; $i < $dataCount; $i++) {
    ...
    $lead_id = $lead_ids[$i];
    $query = "UPDATE leads SET data_sources = '36' WHERE id = '{$lead_id}'";
