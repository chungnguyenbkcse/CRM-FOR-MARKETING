...
$filename = '/home/www/html/mkt.tranthu.vn/custom/modules/Leads/chia_data/8-8-2023/data_8_8.csv';
...
for ($i = 0; $i < $dataCount; $i++) {
    ...
    $query = "UPDATE leads SET created_by = '1', campaign = '4', data_sources = '19', ngay_phat_hanh_the = '2023-08-06' WHERE phone_number_primary = '{$phone_number_primary}' AND deleted = 0";
