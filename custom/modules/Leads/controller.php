...
class LeadsController extends SugarController
{
    ...
    public function action_detail_bu()
    {
        $this->view = 'detail_bu';
        return true;
    }
    ...
    public function action_edit_super_mkt()
    {
        $this->view = 'edit_super_mkt';
        return true;
    }

    public function action_detail_super_mkt()
    {
        $this->view = 'detail_super_mkt';
        return true;
    }
