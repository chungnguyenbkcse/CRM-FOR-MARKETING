...
$hook_array['before_save'][] = Array(2, 'Leads push feed', 'custom/modules/Leads/handle_before_save.php','Handle1', 'handle_before_save'); 
...
$hook_array['after_save'][] = Array(1, 'Handle_after_save', 'custom/modules/Leads/handle_after_save.php','Handle', 'handle_after_save'); 
