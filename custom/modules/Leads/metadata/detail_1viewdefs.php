        ...
        array(
          0 => array(
            ...
            <input 
              ...
              type="button" 
              name="button" 
              onClick="var _form = document.getElementById(\'formDetailView\'); _form.return_module.value=\'Leads\'; _form.return_action.value=\'detail_bu\'; _form.return_id.value=\'{$id}\'; _form.action.value=\'edit_bu\';SUGAR.ajaxUI.submitForm(_form);"
              value="Edit" 
              id="EDIT"
            >'
          ),
