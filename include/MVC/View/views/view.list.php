            ...
            if ($_COOKIE['role']){
                ...
                if ($role == "RO"){
                    if ($user->id == '54e005cb-332b-9c26-c173-6406e116558f') {
                        ...
                        array_push($where_clauses, "  leads.sale_stage != '7' AND ( leads.owned_branch = '9' OR (leads.created_by = '1' AND ( leads.ro_name = '{$user->id}') AND lead_status = '1' AND sale_stage = '1') OR (leads.created_by = '1' AND ( leads.ro_name = '{$user->id}' )) OR (leads.created_by = '{$user->id}') OR (( leads.ro_name = '{$user->id}' ) AND leads.ro_modified_sale_stage = true)  OR (( leads.ro_name = '{$user->id}' ) AND leads.sale_stage = '10' AND leads.sale_stage IS NOT NULL AND leads.sale_stage != '0' AND leads.sale_stage != ''))");
                    }
                    else if ($user->id == '640b5327-a567-bdd1-c73f-64a657064f4a') {
                        array_push($where_clauses, " leads.sale_stage != '7' AND ( leads.owned_branch = 'HCM_3' OR leads.owned_branch = '9' OR leads.owned_branch = '8' OR leads.owned_branch = 'HCM_4'  OR (leads.created_by = '1' AND leads.ro_name = '{$user->id}') OR (leads.created_by = '{$user->id}') OR (leads.ro_name = '{$user->id}' AND leads.ro_modified_sale_stage = true) OR (leads.ro_name = '{$user->id}' AND leads.sale_stage = '10' AND leads.sale_stage IS NOT NULL AND leads.sale_stage != '0' AND leads.sale_stage != ''))");
                    }
                    ...
                    else if ($user->id == '413fda5b-cf08-2583-7706-6406e1753591') {
                        array_push($where_clauses," ((leads.created_by = '1' AND leads.ro_name = '{$user->id}' AND lead_status = '1' AND sale_stage = '1') OR leads.owned_branch = '6' OR ((leads.data_sources = '9' OR leads.data_sources = '10') AND leads.lead_status = '17') OR (leads.created_by = '1' AND leads.ro_name = '{$user->id}') OR (leads.created_by = '{$user->id}') OR (leads.ro_name = '{$user->id}' AND leads.ro_modified_sale_stage = true)  OR (leads.ro_name = '{$user->id}' AND leads.sale_stage = '10' AND leads.sale_stage IS NOT NULL AND leads.sale_stage != '0' AND leads.sale_stage != ''))");
                    }
                    else if ($user->id == '874a0d88-138e-bbd8-a573-6440b69c3aa6' || $user->id == '1b67e2b2-99ce-71d9-6ab4-6440b68dbd20') {
